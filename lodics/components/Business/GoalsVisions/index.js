...
const createImgCardElement = (img, text) => (
  <ImgCardInnerContainer
    $width={text === 'GEOINT' ? '100%' : 'calc(100% / 3 - 2rem)'}
  >
  ...
  return (
    <React.Fragment>
      <Container>
        ...
        <InnerContainer>
          ...
          <ImgCardContainer>
            ...
            {createImgCardElement(
              'img/business/biz01_02_03.png',
              '지형공간정보'
            )}
      ...
      <Container>
        ...
        <p>
          로딕스는 전자정부 개발과 관련되는 업무 전반에 대하여 자문을 제공하고
          있으며, 이에는 한국 모델을 기반으로 한 정부 차원에서 전자정부 개발에
          대한 정책 및 전략 수립,
          <br />
          각 부처 프로젝트의 기획 및 시행, 기술 개발, 자금 조달 등이 포함 되어
          있습니다.
          <br />
          <br />
          저희 고객이 전자정부 개발 관리에 대한 전반적 이해를 돕기 위해
          “전자정부 개발 및 정보통신 산업 육성 전략”이라는 책자를 2016년도에
          출간하였습니다.
        </p>
        <InnerContainer>
